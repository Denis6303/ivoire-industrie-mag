...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/nezzy/categories-style-03.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Mar 2026 09:39:45 GMT -->
<head>
    <meta charset="utf-8">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown"> 
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown03" role="button" data-bs-toggle="dropdown" aria-expanded="false">Features<i class="fas fa-chevron-down fa-xs"></i>
                </a>
                ...
                <a class="nav-link" href="javascript:void(0)" data-bs-toggle="dropdown">Categories<i class="fas fa-chevron-down fa-xs"></i></a>
                  <ul class="dropdown-menu megamenu megamenu-fullwidth">
                    ...
                    <li class="nav-item selected">
                      <a class="dropdown-item active" href="categories-style-03.html">Entertainment</a>
                      <div class="inner-mega-menu">
                        <div class="row">
                          <div class="col">
                            <div class="blog-post post-style-02 mb-3">
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav navbar-nav-style-03">
          ...
          <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown07" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <li class="nav-item dropdown active"> <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown09" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown09">
              ...
              <li class="active"><a class="dropdown-item" href="categories-style-03.html">Entertainment</a></li>
        ...
        <div class="row ">
          <div class="col-md-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><i class="fa-solid fa-chevron-right me-2"></i><span>Entertainment</span></li>
            </ol>
          </div>
        </div>
      </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-4">
                <div class="blog-post post-style-01">
                  <div class="blog-image"> <img class="img-fluid" src="images/category/entertainment/01.jpg" alt=""> </div>
                  <div class="blog-post-details"> <span class="badge badge-large bg-blue">megaphone</span>
                    <h5 class="blog-title"><a href="#">Shouting with megaphone.</a></h5>
                    <div class="blog-post-meta">
                      <div class="blog-post-author"> <span><a href="#"><img src="images/avatar/01.jpg" alt="">Anne Teak</a></span> </div>
                      <div class="blog-post-time"> <a href="#"><i class="fa-solid fa-calendar-days"></i>Jan 6 2022</a> </div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 mb-4">
                <div class="blog-post post-style-01">
                  <div class="blog-image"> <img class="img-fluid" src="images/category/entertainment/02.jpg" alt=""> </div>
                  <div class="blog-post-details"> <span class="badge badge-large bg-primary">operating</span>
                    <h5 class="blog-title"><a href="#">Treat every day like the weekend</a></h5>
                    <div class="blog-post-meta">
                      <div class="blog-post-author"> <span><a href="#"><img src="images/avatar/02.jpg" alt="">Willie Makit</a></span> </div>
                      <div class="blog-post-time"> <a href="#"><i class="fa-solid fa-calendar-days"></i>Jan 25 2022</a> </div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 mb-4">
                <div class="blog-post post-style-01">
                  <div class="blog-image"> <img class="img-fluid" src="images/category/entertainment/03.jpg" alt=""> </div>
                  <div class="blog-post-details"> <span class="badge badge-large bg-yellow">Theater</span>
                    <h5 class="blog-title"><a href="#">Always here for your entertainment</a></h5>
                    <div class="blog-post-meta">
                      <div class="blog-post-author"> <span><a href="#"><img src="images/avatar/03.jpg" alt="">Dave Allippa</a></span> </div>
              ...
              <div class="col-md-6 mb-4">
                <div class="blog-post post-style-01">
                  <div class="blog-image"> <img class="img-fluid" src="images/category/entertainment/04.jpg" alt=""> </div>
                  <div class="blog-post-details"> <span class="badge badge-large bg-purple">Music</span>
                    <h5 class="blog-title"><a href="#">Music is only love looking for words.</a></h5>
                    <div class="blog-post-meta">
                      <div class="blog-post-author"> <span><a href="#"><img src="images/avatar/04.jpg" alt="">Tex Ryta</a></span> </div>
              ...
              <div class="col-md-6 mb-4">
                <div class="blog-post post-style-01">
                  <div class="blog-image"> <img class="img-fluid" src="images/category/entertainment/05.jpg" alt=""> </div>
                  <div class="blog-post-details"> <span class="badge badge-large bg-green">band</span>
                    <h5 class="blog-title"><a href="#">Music is the universal language of mankind.</a></h5>
                    <div class="blog-post-meta">
                      <div class="blog-post-author"> <span><a href="#"><img src="images/avatar/05.jpg" alt="">Theresa Green</a></span> </div>
                      <div class="blog-post-time"> <a href="#"><i class="fa-solid fa-calendar-days"></i>Feb 26 2022</a> </div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 mb-4">
                <div class="blog-post post-style-01">
                  <div class="blog-image"> <img class="img-fluid" src="images/category/entertainment/06.jpg" alt=""> </div>
                  <div class="blog-post-details"> <span class="badge badge-large bg-red">game</span>
                    <h5 class="blog-title"><a href="#">Real gaming takes the stage</a></h5>
                    <div class="blog-post-meta">
                      <div class="blog-post-author"> <span><a href="#"><img src="images/avatar/06.jpg" alt="">Stan Dupp</a></span> </div>
                      <div class="blog-post-time"> <a href="#"><i class="fa-solid fa-calendar-days"></i>Mar 3 2022</a> </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-6 mb-4">
                <div class="blog-post post-style-01">
                  <div class="blog-image"> <img class="img-fluid" src="images/category/entertainment/07.jpg" alt=""> </div>
                  <div class="blog-post-details"> <span class="badge badge-large bg-primary">party</span>
                    <h5 class="blog-title"><a href="#">We are here to rock your party</a></h5>
                    <div class="blog-post-meta">
                      <div class="blog-post-author"> <span><a href="#"><img src="images/avatar/07.jpg" alt="">Neil Down</a></span> </div>
                      <div class="blog-post-time"> <a href="#"><i class="fa-solid fa-calendar-days"></i>Mar 14 2022</a> </div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 mb-4">
                <div class="blog-post post-style-01">
                  <div class="blog-image"> <img class="img-fluid" src="images/category/entertainment/08.jpg" alt=""> </div>
                  <div class="blog-post-details"> <span class="badge badge-large bg-orange">theater</span>
                    <h5 class="blog-title"><a href="#">Top 10 Tips for making</a></h5>
                    <div class="blog-post-meta">
                      <div class="blog-post-author"> <span><a href="#"><img src="images/avatar/08.jpg" alt="">Con Trariweis</a></span> </div>
                      <div class="blog-post-time"> <a href="#"><i class="fa-solid fa-calendar-days"></i>Mar 21 2022</a> </div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 mb-4">
                <div class="blog-post post-style-01">
                  <div class="blog-image"> <img class="img-fluid" src="images/category/entertainment/09.jpg" alt=""> </div>
                  <div class="blog-post-details"> <span class="badge badge-large bg-blue">Magazine</span>
                    <h5 class="blog-title"><a href="#">Create a great understanding with every news</a></h5>
                    <div class="blog-post-meta">
                      <div class="blog-post-author"> <span><a href="#"><img src="images/avatar/09.jpg" alt="">Anna Littlical</a></span> </div>
                      <div class="blog-post-time"> <a href="#"><i class="fa-solid fa-calendar-days"></i>Apr 15 2022</a> </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-6 mb-4">
                <div class="blog-post post-style-01">
                  <div class="blog-image"> <img class="img-fluid" src="images/category/entertainment/10.jpg" alt=""> </div>
                  <div class="blog-post-details"> <span class="badge badge-large bg-yellow">artist</span>
                    <h5 class="blog-title"><a href="#">artist performing on stage</a></h5>
                    <div class="blog-post-meta">
                      <div class="blog-post-author"> <span><a href="#"><img src="images/avatar/03.jpg" alt="">Emma Grate</a></span> </div>
                      <div class="blog-post-time"> <a href="#"><i class="fa-solid fa-calendar-days"></i>Apr 28 2022</a> </div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 mb-4">
                <div class="blog-post post-style-01">
                  <div class="blog-image"> <img class="img-fluid" src="images/category/entertainment/11.jpg" alt=""> </div>
                  <div class="blog-post-details"> <span class="badge badge-large bg-purple">Entertainment</span>
                    <h5 class="blog-title"><a href="#">The next generation of gaming is here.</a></h5>
                    <div class="blog-post-meta">
                      <div class="blog-post-author"> <span><a href="#"><img src="images/avatar/02.jpg" alt="">Anna Littlical</a></span> </div>
                      <div class="blog-post-time"> <a href="#"><i class="fa-solid fa-calendar-days"></i>May 5 2022</a> </div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 mb-4">
                <div class="blog-post post-style-01">
                  <div class="blog-image"> <img class="img-fluid" src="images/category/entertainment/12.jpg" alt=""> </div>
                  <div class="blog-post-details"> <span class="badge badge-large bg-red">party</span>
                    <h5 class="blog-title"><a href="#">Top 10 Tips for making</a></h5>
                    <div class="blog-post-meta">
                      <div class="blog-post-author"> <span><a href="#"><img src="images/avatar/05.jpg" alt="">Anne Gloindian</a></span> </div>
                      <div class="blog-post-time"> <a href="#"><i class="fa-solid fa-calendar-days"></i>May 13 2022</a> </div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 mb-4 mb-md-0">
                <div class="blog-post post-style-01">
                  <div class="blog-image"> <img class="img-fluid" src="images/category/entertainment/13.jpg" alt=""> </div>
                  <div class="blog-post-details"> <span class="badge badge-large bg-orange">stemming</span>
                    <h5 class="blog-title"><a href="#">Live Dreaming, Paint Streaming</a></h5>
                    <div class="blog-post-meta">
                      <div class="blog-post-author"> <span><a href="#"><img src="images/avatar/03.jpg" alt="">Dulcie Veeta</a></span> </div>
                      <div class="blog-post-time"> <a href="#"><i class="fa-solid fa-calendar-days"></i>May 27 2022</a> </div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 mb-4 mb-md-0">
                <div class="blog-post post-style-01">
                  <div class="blog-image"> <img class="img-fluid" src="images/category/entertainment/14.jpg" alt=""> </div>
                  <div class="blog-post-details"> <span class="badge badge-large bg-primary">Entertainment</span>
                    <h5 class="blog-title"><a href="#">I stand with black lives</a></h5>
                    <div class="blog-post-meta">
                      <div class="blog-post-author"> <span><a href="#"><img src="images/avatar/06.jpg" alt="">Barry Cuda</a></span> </div>
            ...
            <div class="sidebar mt-lg-0">
              ...
              <div class="widget newsletter-widget">
                ...
                <div class="blog-post post-style-02">
                  <div class="blog-image">
                    <img class="img-fluid" src="images/category/entertainment/15.jpg" alt="">
                  </div>
                  <span class="badge badge-large bg-orange">artist</span>
                  <div class="blog-post-details">
                    <h6 class="blog-title"><a href="#">Russia-Ukraine crisis</a></h6>
                    <div class="blog-post-meta">
                      <div class="blog-post-time">
                        <a href="#"><i class="fa-solid fa-calendar-days"></i>Jun 23 2022</a>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="blog-post post-style-13">
                  <div class="blog-post-details">
                    <span class="badge text-blue">Entertainment</span>
                    <h6 class="blog-title"><a href="#">Time is greater than money</a></h6>
                      <div class="blog-post-meta">
                        <div class="blog-post-time">
                          <a href="#"><i class="fa-solid fa-calendar-days"></i>Jul 5 2022</a>
                        </div>
                        <div class="blog-post-comment">
                          <a href="#"><i class="fa-regular fa-comment"></i>(6)</a>
                        </div>
                ...
                <div class="blog-post post-style-13">
                  <div class="blog-post-details">
                    <span class="badge text-green">stemming</span>
                    <h6 class="blog-title"><a href="#">The UK will end all COVID travel rules from March 18</a></h6>
                      <div class="blog-post-meta">
                        <div class="blog-post-time">
                          <a href="#"><i class="fa-solid fa-calendar-days"></i>Jul 16 2022</a>
                        </div>
                        <div class="blog-post-comment">
              ...
              <div class="widget add-widget">
                <div class="add-banner">
                  <a href="https://themeforest.net/item/car-dealer-automotive-responsive-wordpress-theme/20213334?s_rank=21"><img class="img-fluid" src="images/bg/add-02.jpg" alt=""></a>
                </div>
              </div>
                ...
                <ul>
                  ...
                  <li>
                    <a href="#">
                      <div class="category">
                         <div class="category-image">
                            <img class="img-fluid" src="images/category/20.jpg" alt="">
                         </div>
                         <div class="category-name">
                  ...
                  <li>
                    <a href="#">
                      <div class="category">
                         <div class="category-image">
                            <img class="img-fluid" src="images/category/19.jpg" alt="">
                         </div>
                         <div class="category-name">
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-lg-6 col-md-6 mb-4">
            ...
            <ul class="footer-insta">
              <li>
                <a href="#"><img class="img-fluid" src="images/instagram/06.jpg" alt="#"></a> <span><i class="fa-brands fa-instagram "></i></span> </li>
              <li>
                <a href="#"><img class="img-fluid" src="images/instagram/07.jpg" alt="#"></a> <span><i class="fa-brands fa-instagram "></i></span> </li>
              <li>
                <a href="#"><img class="img-fluid" src="images/instagram/08.jpg" alt="#"></a> <span><i class="fa-brands fa-instagram "></i></span> </li>
              <li>
                <a href="#"><img class="img-fluid" src="images/instagram/09.jpg" alt="#"></a> <span><i class="fa-brands fa-instagram "></i></span> </li>
              <li>
                <a href="#"><img class="img-fluid" src="images/instagram/10.jpg" alt="#"></a> <span><i class="fa-brands fa-instagram "></i></span> </li>
              <li>
                <a href="#"><img class="img-fluid" src="images/instagram/11.jpg" alt="#"></a> <span><i class="fa-brands fa-instagram "></i></span> </li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row copyright justify-content-center">
          <div class="col-md-12 text-center">
            <p class="mb-0">Copyright © <span id="copyright"> <script>document.getElementById('copyright').appendChild(document.createTextNode(new Date().getFullYear()))</script></span> by <a href="index.html"> Nezzy</a>. All Rights Reserved</p>
          </div>
        </div>
      </div>
    </div>
...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/nezzy/categories-style-03.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Mar 2026 09:39:48 GMT -->
</html>
