...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/nezzy/categories-style-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Mar 2026 09:39:42 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <header class="header header-sticky">
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container position-relative">
          <a class="navbar-brand" href="index.html"><img class="img-fluid" src="images/logo-dark.png" alt="logo"></a>
                ...
                <a class="nav-link" href="javascript:void(0)" data-bs-toggle="dropdown">Categories<i class="fas fa-chevron-down fa-xs"></i></a>
                  <ul class="dropdown-menu megamenu megamenu-fullwidth">
                    ...
                    <li class="nav-item selected">
                      <a class="dropdown-item active" href="categories-style-02.html">Sport</a>
                      <div class="inner-mega-menu">
                        <div class="row">
                          <div class="col">
                            <div class="blog-post post-style-02 mb-3">
        ...
        <ul class="navbar-nav navbar-nav-style-03">
          ...
          <li class="nav-item dropdown active"> <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown09" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown09">
              ...
              <li  class="active"><a class="dropdown-item" href="categories-style-02.html">Sport</a></li>
        ...
        <div class="row ">
          <div class="col-md-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><i class="fa-solid fa-chevron-right me-2"></i><span>Sport</span></li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-7 col-xl-8">
            <div class="row">
              <div class="col-md-6 mb-4">
                <div class="blog-post post-style-06">
                  <div class="blog-image">
                    <img class="img-fluid" src="images/category/sport/02.jpg" alt="">
                  </div>
                  <div class="blog-details">
                    <div class="blog-post-details">
                      <span class="badge badge-style-03">Football</span>
                      <h6 class="blog-title"><a href="blog-single-04.html">Football Goals are attained by Perseverance</a></h6>
              ...
              <div class="col-md-6 mb-4">
                <div class="blog-post post-style-06">
                  <div class="blog-image">
                    <img class="img-fluid" src="images/category/sport/03.jpg" alt="">
                  </div>
                  <div class="blog-details">
                    <div class="blog-post-details">
                      <span class="badge badge-style-03 text-pink">basketball</span>
                      <h6 class="blog-title"><a href="blog-single-04.html">Everyone grows when they play basketball.</a></h6>
                      <div class="blog-post-meta">
                        <div class="blog-post-time">
                          <a href="#"><i class="fa-solid fa-calendar-days"></i>Jan 16 2022</a>
                        </div>
                        <div class="blog-post-comment">
                    ...
                    <div class="blog-content">
                      <p>We carry them with us like rocks in a knapsack.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 mb-4">
                <div class="blog-post post-style-06">
                  <div class="blog-image">
                    <img class="img-fluid" src="images/category/sport/04.jpg" alt="">
                  </div>
                  <div class="blog-details">
                    <div class="blog-post-details">
                      <span class="badge badge-style-03 text-yellow">tennis</span>
                      <h6 class="blog-title"><a href="blog-single-04.html">I play Tennis, What’s your superpower</a></h6>
                      <div class="blog-post-meta">
                        <div class="blog-post-time">
                    ...
                    <div class="blog-content">
                      <p>Some people call this a sense of deserving.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 mb-4">
                <div class="blog-post post-style-06">
                  <div class="blog-image">
                    <img class="img-fluid" src="images/category/sport/05.jpg" alt="">
                  </div>
                  <div class="blog-details">
                    <div class="blog-post-details">
                      <span class="badge badge-style-03 text-red">baseball</span>
                      <h6 class="blog-title"><a href="blog-single-04.html">Life is a Game. Baseball is Serious.</a></h6>
                      <div class="blog-post-meta">
                        <div class="blog-post-time">
                          <a href="#"><i class="fa-solid fa-calendar-days"></i>Feb 18 2022</a>
                        </div>
                        <div class="blog-post-comment">
                    ...
                    <div class="blog-content">
                      <p>It turned out to be the Hope Diamond.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 mb-4">
                <div class="blog-post post-style-06">
                  <div class="blog-image">
                    <img class="img-fluid" src="images/category/sport/06.jpg" alt="">
                  </div>
                  <div class="blog-details">
                    <div class="blog-post-details">
                      <span class="badge badge-style-03 text-orange">golf</span>
                      <h6 class="blog-title"><a href="blog-single-04.html">Golf is our favorite game</a></h6>
                      <div class="blog-post-meta">
                        <div class="blog-post-time">
                          <a href="#"><i class="fa-solid fa-calendar-days"></i>Feb 27 2022</a>
                        </div>
                        <div class="blog-post-comment">
                    ...
                    <div class="blog-content">
                      <p>Make no mistake, the new owner already had money.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 mb-4">
                <div class="blog-post post-style-06">
                  <div class="blog-image">
                    <img class="img-fluid" src="images/category/sport/07.jpg" alt="">
                  </div>
                  <div class="blog-details">
                    <div class="blog-post-details">
                      <span class="badge badge-style-03 text-purple">volleyball</span>
                      <h6 class="blog-title"><a href="blog-single-04.html">Winning isn't everything, but wanting it is.</a></h6>
                      <div class="blog-post-meta">
                        <div class="blog-post-time">
                    ...
                    <div class="blog-content">
                      <p>That stream bed was littered with diamonds.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 mb-4">
                <div class="blog-post post-style-06">
                  <div class="blog-image">
                    <img class="img-fluid" src="images/category/sport/08.jpg" alt="">
                  </div>
                  <div class="blog-details">
                    <div class="blog-post-details">
                      <span class="badge badge-style-03 text-skyblue">badminton</span>
                      <h6 class="blog-title"><a href="blog-single-04.html">All badminton players are not created equal</a></h6>
                      <div class="blog-post-meta">
                        <div class="blog-post-time">
                          <a href="#"><i class="fa-solid fa-calendar-days"></i>Mar 30 2022</a>
                        </div>
                        <div class="blog-post-comment">
              ...
              <div class="col-md-6 mb-4">
                <div class="blog-post post-style-06">
                  <div class="blog-image">
                    <img class="img-fluid" src="images/category/sport/09.jpg" alt="">
                  </div>
                  <div class="blog-details">
                    <div class="blog-post-details">
                      <span class="badge badge-style-03">cricket</span>
                      <h6 class="blog-title"><a href="blog-single-04.html">SmartBall Set to Revolutionise Cricket Analytics</a></h6>
                      <div class="blog-post-meta">
                        <div class="blog-post-time">
                          <a href="#"><i class="fa-solid fa-calendar-days"></i>Apr 9 2022</a>
                        </div>
                        <div class="blog-post-comment">
                          <a href="#"><i class="fa-regular fa-comment"></i>(9)</a>
                        </div>
                    ...
                    <div class="blog-content">
                      <p>If the plan doesn’t support the vision then change it!</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 mb-4 mb-md-0">
                <div class="blog-post post-style-06">
                  <div class="blog-image">
                    <img class="img-fluid" src="images/category/sport/10.jpg" alt="">
                  </div>
                  <div class="blog-details">
                    <div class="blog-post-details">
                      <span class="badge badge-style-03 text-primary">Skiing</span>
                      <h6 class="blog-title"><a href="blog-single-04.html">Your Guide to Skiing on Big Bear’s Snow Summit</a></h6>
                      <div class="blog-post-meta">
                        <div class="blog-post-time">
                          <a href="#"><i class="fa-solid fa-calendar-days"></i>Apr 19 2022</a>
                        </div>
                        <div class="blog-post-comment">
                          <a href="#"><i class="fa-regular fa-comment"></i>(7)</a>
                        </div>
                    ...
                    <div class="blog-content">
                      <p>This is where you create powerful, progressive change.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 mb-4 mb-md-0">
                <div class="blog-post post-style-06">
                  <div class="blog-image">
                    <img class="img-fluid" src="images/category/sport/11.jpg" alt="">
                  </div>
                  <div class="blog-details">
                    <div class="blog-post-details">
                      <span class="badge badge-style-03 text-yellow">Kenna Kaut</span>
                      <h6 class="blog-title"><a href="blog-single-04.html">Stillwater’s Carly Fedorowski is East Metro Girls Lacrosse Player of Year</a></h6>
                      <div class="blog-post-meta">
                        <div class="blog-post-time">
                          <a href="#"><i class="fa-solid fa-calendar-days"></i>May 12 2022</a>
                        </div>
                        <div class="blog-post-comment">
                          <a href="#"><i class="fa-regular fa-comment"></i>(4)</a>
                        </div>
                    ...
                    <div class="blog-content">
                      <p>You have the freedom to be how you want to be.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="sidebar mt-lg-0">
              ...
              <div class="widget newsletter-widget">
                ...
                <div class="blog-post post-style-02">
                  <div class="blog-image">
                    <img class="img-fluid" src="images/category/sport/12.jpg" alt="">
                  </div>
                  <span class="badge badge-large bg-orange">football</span>
                  <div class="blog-post-details">
                    <h6 class="blog-title"><a href="#">perfect practice makes perfect.</a></h6>
                    <div class="blog-post-meta">
                      <div class="blog-post-time">
                        <a href="#"><i class="fa-solid fa-calendar-days"></i>May 26 2022</a>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="blog-post post-style-13">
                  <div class="blog-post-details">
                    <span class="badge text-purple">baseball</span>
                    <h6 class="blog-title"><a href="#">Every match is the last chance to prove yourself</a></h6>
                      <div class="blog-post-meta">
                        <div class="blog-post-time">
                          <a href="#"><i class="fa-solid fa-calendar-days"></i>Jun 16 2022</a>
                        </div>
                        <div class="blog-post-comment">
                          <a href="#"><i class="fa-regular fa-comment"></i>(6)</a>
                        </div>
                ...
                <div class="blog-post post-style-13">
                  <div class="blog-post-details">
                    <span class="badge text-red">Rugby</span>
                    <h6 class="blog-title"><a href="#">If you really want to see stars, play rugby.</a></h6>
                      <div class="blog-post-meta">
                        <div class="blog-post-time">
                          <a href="#"><i class="fa-solid fa-calendar-days"></i>Jul 15 2022</a>
                        </div>
                        <div class="blog-post-comment">
                          <a href="#"><i class="fa-regular fa-comment"></i>(4)</a>
                        </div>
...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/nezzy/categories-style-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Mar 2026 09:39:45 GMT -->
</html>
