...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/nezzy/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Mar 2026 09:39:32 GMT -->
<head>
    <meta charset="utf-8">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown active">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown2" role="button" data-bs-toggle="dropdown" aria-expanded="false">Pages<i class="fas fa-chevron-down fa-xs"></i></a>
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown2">
                  <li><a class="dropdown-item" href="about-us.html">About Us</a></li>
                  <li class="active"><a class="dropdown-item" href="team.html">Team</a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu megamenu dropdown-menu-md" aria-labelledby="navbarDropdown3">
                  <li>
                    <div class="row">
                      <div class="col-sm-6">
        ...
        <div class="row ">
          <div class="col-md-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><i class="fa-solid fa-chevron-right me-2"></i><span>Team</span></li>
            </ol>
          </div>
        </div>
      </div>
         ...
         <div class="row">
          ...
          <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="team">
              ...
              <div class="team-info">
                <a href="#" class="team-name">Melanie Byrd</a>
                <p>Albany Reporter</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="team">
              ...
              <div class="team-info">
                <a href="#" class="team-name">Harry Russell</a>
                <p>Anchor</p>
              </div>
            </div>
          </div>
...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/nezzy/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Mar 2026 09:39:33 GMT -->
</html>
