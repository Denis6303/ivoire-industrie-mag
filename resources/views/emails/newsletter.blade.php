...
<body style="margin:0;padding:0;background:#f8f9fa;font-family:Arial,Helvetica,sans-serif;">
    <div style="max-width:600px;margin:0 auto;padding:24px;">
        <div style="background:#1b4332;color:#fff;padding:16px;border-radius:8px 8px 0 0;">
            <div style="font-size:18px;font-weight:700;">ivoireindustrie<span style="color:#d97706;">mag</span></div>
        </div>
