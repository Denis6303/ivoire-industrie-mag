...
@section('content')
    <div class="d-flex align-items-center justify-content-between mb-3">
        <h1 class="h4 mb-0">Créer une offre d'emploi</h1>
        <a href="{{ route('admin.emplois.index') }}" class="btn btn-outline-secondary btn-sm">Retour</a>
    </div>

    <div class="card card-mag">
        <div class="card-body">
            <form id="job-form" method="POST" action="{{ route('admin.emplois.store') }}" enctype="multipart/form-data" class="row g-3">
                @csrf
                <div class="col-12">
                ...
                <div class="col-12">
                    ...
                    <input name="signature" class="form-control" value="{{ old('signature') }}">
                </div>
                <div class="col-12">
